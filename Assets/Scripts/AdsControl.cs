    ...
    public void RequestAndLoadRewardedAd()
    {
       // PrintStatus("Requesting Rewarded ad.");
        ...
        rewardedAd.OnUserEarnedReward += (sender, args) =>
        {
            ...
            if (currentType == REWARD_TYPE.BONUS_COIN)
            {
                GameManager.instance.GetBonusCoin();
            }
            else if (currentType == REWARD_TYPE.BONUS_LIFE)
            {
                GameManager.instance.GetBonusLife();
            }
            else if (currentType == REWARD_TYPE.BONUS_MAGNET)
            {
                GameManager.instance.GetMagnet();
            }
            else if (currentType == REWARD_TYPE.GET_CHARACTER)
            {
                GameManager.instance.uiManager.victoryPanel.TryChar();
            }
            else if (currentType == REWARD_TYPE.TRY_CHARACTER)
            {
                GameManager.instance.uiManager.victoryPanel.GetChar();
            }

            else if (currentType == REWARD_TYPE.RETRIVE)
            {
                GameManager.instance.uiManager.retrivePanel.RevertPlayer();
            }
